...
const Register = () => {
  ...
  const handleRegister = async () => {
    ...
    // 1. Create user account with company metadata
    ...
    if (signUpError) {
      ...
      toast({
        ...
        description: signUpError.message || "حدث خطأ أثناء إنشاء الحساب",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      ...
      description: "مرحباً بك في HisabiX - سيتم توجيهك الآن",
    });
    navigate("/dashboard");
  };
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Button
                      variant="outline"
                      className="w-full h-12 bg-warning text-card-foreground hover:bg-warning/90"
                    >
